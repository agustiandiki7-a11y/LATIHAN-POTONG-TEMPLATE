...
$id_mobile = mysqli_real_escape_string($koneksi, $_POST['id_mobile']);

// Mengambil data nama dari form
$vnama = mysqli_real_escape_string($koneksi, $_POST['nama']);

// Mengambil data kode icon dari form
$vicon = mysqli_real_escape_string($koneksi, $_POST['icon']);
