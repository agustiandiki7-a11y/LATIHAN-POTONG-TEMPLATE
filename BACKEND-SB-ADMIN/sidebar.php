...
<li class="nav-item">
    ...
    <!-- 7. Portofolio (Sudah Diperbaiki ke tabel_portofolio.php) -->
    <li class="nav-item">
        <a class="nav-link" href="tabel_portofolio.php">
...
<a class="nav-link" href="tabel_mobile.php">
    ...
    <!-- 11. Familiar Icon (Sudah Ditambah .php) -->
    <li class="nav-item">
